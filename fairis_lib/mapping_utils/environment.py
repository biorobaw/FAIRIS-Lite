    ...
    def __init__(self, maze_file):
        ...
        for index, row in landmarks.iterrows():
            self.landmarks.append(
                Landmark(row['x'], row['y'], height=row['height'], color=[row['red'], row['green'], row['blue']],
                         id=index))
...
class Landmark:
    ...
    def get_webots_node_string(self):
        node_string = "{translation} {color} {recognitionColors} {size}".format(
            translation=self.get_webots_translation_string(),
